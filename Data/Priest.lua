...
lib:RegisterSpells({
    ...
    },
    {
        ...
        duration = 15,
        priority = 4,
        ranks = {139, 6074, 6075, 6076, 6077, 6078, 10927, 10928, 10929, 25221, 25222, 25315},
        auraTarget = AT.ALLY,  -- Can target other players
        specs = {S.HOLY, S.DISCIPLINE},
    },
    {
        ...
        cooldown = 0,
        priority = 5,
        ranks = {2060, 10963, 10964, 10965, 25210, 25213, 25314},
        auraTarget = AT.ALLY,  -- Can target other players
        specs = {S.DISCIPLINE, S.HOLY},
    },
    {
    ...
    },
    {
        ...
        cooldown = 0,
        priority = 8,
        ranks = {596, 996, 10960, 10961, 25308, 25316},
    ...
    -------------------------------------------------------------------------------
    {
        ...
        cooldown = 10,
        ranks = {14914, 15261, 15262, 15263, 15264, 15265, 15266, 15267, 25384},
