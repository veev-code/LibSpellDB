...
lib:RegisterSpells({
    ...
    },
    {
        ...
        cooldown = 0,
        priority = 4,
        ranks = {22568, 22827, 22828, 22829, 24248, 31018},
        specs = {S.FERAL},
    },
    ...
    },
    {
        ...
        cooldown = 0,
        priority = 3,
        ranks = {769, 779, 780, 9754, 9908, 26997},
        specs = {S.FERAL},
    },
    {
        ...
        tags = {C.TANK, C.ROTATIONAL, C.MINOR, C.PVE, C.BEAR_FORM, C.SWING_RESET},
        cooldown = 0,
        priority = 10,
    ...
    -------------------------------------------------------------------------------
    {
        ...
        duration = 1800,
        dispelType = "Magic",
        ranks = {1126, 5232, 5234, 6756, 8907, 9884, 9885, 26990},
        auraTarget = AT.ALLY,
        specs = {S.BALANCE, S.FERAL, S.RESTORATION},
