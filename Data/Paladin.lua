...
lib:RegisterSpells({
    ...
    },
    {
        ...
        tags = {C.HEAL_SINGLE, C.CORE_ROTATION, C.OFFENSIVE_CD_MINOR},
        cooldown = 30,
        talent = true,
        ranks = {20473, 20929, 20930},
    },
    ...
    },
    {
        ...
        duration = 8,
        talent = true,
        ranks = {26573, 20116, 20922, 20923, 20924},
    },
    {
        spellID = 31935,  -- Avenger's Shield (TBC+)
    ...
    },
    {
        ...
        tags = {C.BUFF, C.UTILITY, C.RESOURCE},
        cooldown = 0,
        duration = 300,
    ...
    },
    {
        ...
        tags = {C.BUFF, C.EXTERNAL_DEFENSIVE},
        cooldown = 0,
        duration = 300,
        talent = true,
    ...
    {
        spellID = 20925,  -- Holy Shield
        tags = {C.PERSONAL_DEFENSIVE, C.TRACK_BUFF},
        cooldown = 10,
        duration = 10,
        talent = true,
        ranks = {20925, 20927, 20928},
    },
    ...
    -------------------------------------------------------------------------------
    {
        ...
        tags = {C.DISPEL_MAGIC, C.DISPEL_POISON, C.DISPEL_DISEASE},
        cooldown = 0,
    },
    {
        spellID = 1152,  -- Purify
        tags = {C.DISPEL_POISON, C.DISPEL_DISEASE},
        cooldown = 0,
    },
